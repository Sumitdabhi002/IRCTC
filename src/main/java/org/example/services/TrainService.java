...
public class TrainService {
    ...
    private static final String TRAIN_PATH = "C:\\Users\\SUMIT\\Desktop\\java project\\IRCTC\\src\\main\\java\\org\\example\\localdb\\train.json";
        ...
        try {
            ...
            if (row >= 0 && row < seats.size() && seat >= 0 && seat < seats.get(row).size()) {
                if (seats.get(row).get(seat) == 0) {
                    ...
                    updateTrain(train); // save updated state
                    return true;
                }
